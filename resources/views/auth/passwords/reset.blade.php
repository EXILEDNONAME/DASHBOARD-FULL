	...
	<div id="page-container" class="fade">
        ...
        <form method="POST" action="{{ route('password.update') }}">
          ...
          <div class="form-group m-b-20">
						<input id="email" type="text" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" placeholder="Email" required>
					</div>
          <div class="form-group m-b-20">
          ...
          <div class="form-group m-b-20">
						<input id="password-confirm" type="password" class="form-control form-control-lg" name="password_confirmation" placeholder="Password" required autocomplete="new-password">
					</div>
					<p>
            <p>
